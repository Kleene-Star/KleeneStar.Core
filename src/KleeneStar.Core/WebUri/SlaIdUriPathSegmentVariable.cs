...
{
    /// <summary>
    /// Variable path segment carrying an <see cref="Model.Entities.SlaPolicy"/> id.
    /// </summary>
    /// <typeparam name="TParameter">The parameter type.</typeparam>
    public class SlaIdUriPathSegmentVariable<TParameter> : UriPathSegmentVariableGuid<TParameter>
        where TParameter : IParameterStatic, new()
    {
        ...
        public SlaIdUriPathSegmentVariable(object tag = null)
            : base(tag)
        {
        }
        ...
        {
            return new SlaIdUriPathSegmentVariable<TParameter>(this)
            {
        ...
        public override bool IsMatched(string value)
        {
            ...
            else if (SlaManager.ReservedSlaNames.Contains(value?.Trim().ToLower()))
            {
                return false;
            }
        ...
        /// <returns>A string containing the display text, or <c>null</c>.</returns>
        ...
        /// </summary>
        /// <param name="renderContext">The render context.</param>
        /// <returns>An icon, or <c>null</c>.</returns>

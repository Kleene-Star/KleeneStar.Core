...
namespace KleeneStar.Core.WebUri
{
    ...
    public class WorkflowStateIdUriPathSegmentVariable<TParameter> : UriPathSegmentVariableGuid<TParameter>
        where TParameter : IParameterStatic, new()
    {
        ...
        public WorkflowStateIdUriPathSegmentVariable(object tag = null)
            : base(tag)
        {
        }
        ...
        {
            return new WorkflowStateIdUriPathSegmentVariable<TParameter>(this)
            {

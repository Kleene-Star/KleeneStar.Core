...
namespace KleeneStar.Core.WebAttribute
{
    ...
    public class FormIdSegmentAttribute : Attribute, IEndpointAttribute, ISegmentAttribute
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public FormIdSegmentAttribute()
        {
        }
        ...
        {
            return new FormIdUriPathSegmentVariable<FormIdParameter>();
        }
    }
}

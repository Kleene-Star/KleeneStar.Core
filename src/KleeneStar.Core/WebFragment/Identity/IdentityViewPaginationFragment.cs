...
{
    /// <summary>
    /// Provides a footer fragment that enables pagination controls for identity views.
    /// </summary>
    [Section<SectionViewFooterPrimary>]
    [Scope<IdentityViewFragment>]
    [Cache]
    public sealed class IdentityViewPaginationFragment : FragmentControlViewFooter
    {
        /// <summary>
        /// Represents the unique identifier for the content used in this context.
        /// </summary>
        public static readonly string ContentId = "id_1A4F8E2B5C7D43A18B0E296CFA37D854";
        ...
        public IdentityViewPaginationFragment(IFragmentContext fragmentContext)

...
{
    /// <summary>
    /// Represents a fragment control for managing group tables.
    /// </summary>
    [Section<SectionContentPrimary>]
    [Scope<global::KleeneStar.Core.WWW.Settings.Groups.Index>]
    [Cache]
    public sealed class GroupViewFragment : FragmentControlView
    {
        /// <summary>
        ...
        {
            RestUri = _ => CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Groups.Wql>()
        };
        ...
        {
            RestUri = _ => CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Groups.Quickfilter>()
        };
        ...
        {
            RestUri = _ => CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Groups.Table>()
        };
        ...
        /// </summary>
        public ControlPagination Pagination { get; } = new ControlPagination("id_group_pagination")
        {
        };
        ...
        /// </summary>
        public GroupViewFragment(IFragmentContext fragmentContext)

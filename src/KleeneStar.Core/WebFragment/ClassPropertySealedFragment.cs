...
{
    /// <summary>
    /// Represents a property fragment that displays whether a class is sealed in the detail view.
    /// </summary>
    [Section<SectionPropertyPrimary>]
    [Scope<global::KleeneStar.Core.WWW.Class._classid_.Index>]
    [Cache]
    public sealed class ClassPropertySealedFragment : FragmentControlAttribute
    {
        /// <summary>
        ...
        public override IHtmlNode Render(IRenderControlContext renderContext, IVisualTreeControl visualTree)
        {
            ...
            var value = @class?.Sealed == true ? "yes" : "no";

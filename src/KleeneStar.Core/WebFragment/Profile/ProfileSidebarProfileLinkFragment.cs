...
{
    /// <summary>
    /// Sidebar link to the profile landing page (display name, avatar, contact channels).
    /// </summary>
    ...
    [Cache]
    public sealed class ProfileSidebarProfileLinkFragment : FragmentControlSidebarItemLink
    {
        private static readonly IUri _uri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Profile.Index>();

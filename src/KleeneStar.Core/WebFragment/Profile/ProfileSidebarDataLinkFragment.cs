...
{
    /// <summary>
    /// Sidebar link to the data export / activity log page.
    /// </summary>
    ...
    [Cache]
    public sealed class ProfileSidebarDataLinkFragment : FragmentControlSidebarItemLink
    {
        private static readonly IUri _uri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Profile.Data>();
        ...
        /// </param>
        public ProfileSidebarDataLinkFragment(IFragmentContext fragmentContext)
            : base(fragmentContext)
        {
            Icon = _ => new IconDatabase(TypeIconTheme.Light);
            Text = _ => "kleenestar.core:profile.data.title";
            Uri = _ => _uri;

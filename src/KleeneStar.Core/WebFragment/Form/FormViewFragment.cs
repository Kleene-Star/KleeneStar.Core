...
namespace KleeneStar.Core.WebFragment.Form
{
    ...
    public sealed class FormViewFragment : FragmentControlView
    {
        ...
        {
            RestUri = _ => CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Forms.Wql>()
        };
        ...
        {
            RestUri = _ => CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Forms._classid_.Quickfilter>()
        };

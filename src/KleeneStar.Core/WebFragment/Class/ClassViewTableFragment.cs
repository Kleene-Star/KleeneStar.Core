...
namespace KleeneStar.Core.WebFragment.Class
{
    ...
    [Cache]
    public sealed class ClassViewTableFragment : FragmentControlViewItem
    {
        /// <summary>
        ...
        {
            ServiceFactory = _ => DataServiceDescriptor.TableData(CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Classes._workspacekey_.Table>().ToString())};

        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        /// <param name="fragmentContext">The context of the fragment.</param>
        public ClassViewTableFragment(IFragmentContext fragmentContext)

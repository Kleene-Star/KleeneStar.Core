...
{
    /// <summary>
    /// Provides a footer fragment that enables pagination controls for class views.
    /// </summary>
    [Section<SectionViewFooterPrimary>]
    //[Policy<ClassViewPolicy>]
    [Scope<ClassViewFragment>]
    [Cache]
    public sealed class ClassViewPaginationFragment : FragmentControlViewFooter
    {
        /// <summary>
        /// Represents the unique identifier for the content used in this context.
        /// </summary>
        public static readonly string ContentId = "id_79043BE0F9D347A3957DAC8BEB1ED607";
        ...
        public ClassViewPaginationFragment(IFragmentContext fragmentContext)

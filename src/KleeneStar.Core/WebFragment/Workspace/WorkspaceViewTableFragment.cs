...
namespace KleeneStar.Core.WebFragment.Workspace
{
    ...
    [Cache]
    public sealed class WorkspaceViewTableFragment : FragmentControlViewItem
    {
        /// <summary>
        ...
        {
            ServiceFactory = _ => DataServiceDescriptor.TableData(CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Workspaces.Table>().ToString())};

        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        /// <param name="fragmentContext">The context of the fragment.</param>
        public WorkspaceViewTableFragment(IFragmentContext fragmentContext)

...
namespace KleeneStar.Core.WebFragment.Workspace
{
    ...
    [Scope<WWW.Workspace.Id.Clone>]
    [Cache]
    public sealed class FragmentWorkspaceFormClone : FragmentControlRestFormClone
    {
        /// <summary>
        ...
        public FragmentWorkspaceFormClone(IFragmentContext fragmentContext)

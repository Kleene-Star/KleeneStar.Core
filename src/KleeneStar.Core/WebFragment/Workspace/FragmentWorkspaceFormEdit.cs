...
namespace KleeneStar.Core.WebFragment.Workspace
{
    ...
    [Scope<WWW.Workspace.Id.Edit>]
    [Cache]
    public sealed class FragmentWorkspaceFormEdit : FragmentControlRestFormEdit
    {
        /// <summary>
        ...
        public FragmentWorkspaceFormEdit(IFragmentContext fragmentContext)

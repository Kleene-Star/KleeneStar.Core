...
{
    /// <summary>
    /// Displays assigned tenants in read-only mode.
    /// </summary>
    ...
    public sealed class WorkspacePropertyTenantFragment : FragmentControlAttribute
    {
        ...
        public override IHtmlNode Render(IRenderControlContext renderContext, IVisualTreeControl visualTree)
        {
            ...
            var tenants = WorkspacePropertyValueHelper.JoinEnumerable(WorkspacePropertyValueHelper.ReadValue(workspace, "Tenant"));

            return base.Render(renderContext, visualTree, Key, tenants, Uri, Icon);
        }
    }
}

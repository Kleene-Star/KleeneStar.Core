...
{
    /// <summary>
    /// Represents a property fragment that displays the creation date of a class in the detail view.
    /// </summary>
    [Section<SectionPropertyPrimary>]
    [Scope<global::KleeneStar.Core.WWW.Class._classid_.Index>]
    [Cache]
    public sealed class ClassPropertyCreatedFragment : FragmentControlAttribute
    {
        /// <summary>

...
namespace KleeneStar.Core.WebFragment
{
    ...
    /// </summary>
    [Title("kleenestar.core:state.add.title")]
    [Section<SectionContentPreferences>]
    [Scope<global::KleeneStar.Core.WWW.States._classid_.Add>]
    [Cache]
    public sealed class StateAddFormFragment : FragmentControlRestFormAdd
    {
        /// <summary>
        ...
        public StateAddFormFragment(IFragmentContext fragmentContext)

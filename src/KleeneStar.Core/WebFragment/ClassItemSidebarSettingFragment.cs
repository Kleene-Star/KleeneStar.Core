...
namespace KleeneStar.Core.WebFragment
{
    ...
    public sealed class ClassItemSidebarSettingFragment : FragmentControlToolbarItemDropdown
    {
        ...
        public override IHtmlNode Render(IRenderControlContext renderContext, IVisualTreeControl visualTree)
        {
            ...
            var editUri = CoreHub.GetUri<WWW.Classes._workspacekey_._classid_.Edit>()?
                .BindParameters(keyParameter)
                .BindParameters(renderContext.Request);
            var cloneUri = CoreHub.GetUri<WWW.Classes._workspacekey_._classid_.Clone>()?
                .BindParameters(keyParameter)
                .BindParameters(renderContext.Request);
            var deleteUri = CoreHub.GetUri<WWW.Classes._workspacekey_._classid_.Delete>()?
                .BindParameters(keyParameter)
                .BindParameters(renderContext.Request);

...
namespace KleeneStar.Core.WebFragment
{
    ...
    public sealed class StatusViewFragment : FragmentControlView
    {
        ...
        {
            RestUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Statuses.Wql>()
        };

        /// <summary>
        /// Gets the quick filter control for REST-based workflow state queries.
        /// </summary>
        public ControlRestQuickfilter Quickfilter { get; } = new ControlRestQuickfilter()
        {
            RestUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Statuses._classid_.Quickfilter>()
        };
        ...
        {
            RestUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Statuses._classid_.Table>()
        };

...
{
    /// <summary>
    /// Represents the edit form fragment of a security level.
    /// </summary>
    [Section<SectionContentPreferences>]
    [Scope<global::KleeneStar.Core.WWW.SecurityLevel._securitylevelid_.Edit>]
    [Cache]
    public sealed class SecurityLevelEditFormFragment : FragmentControlDataFormEdit
    {
        /// <summary>
        ...
        public SecurityLevelEditFormFragment(IFragmentContext fragmentContext)

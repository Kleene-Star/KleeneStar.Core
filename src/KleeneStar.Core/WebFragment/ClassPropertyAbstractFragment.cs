...
{
    /// <summary>
    /// Represents a property fragment that displays whether a class is abstract in the detail view.
    /// </summary>
    [Section<SectionPropertyPrimary>]
    [Scope<global::KleeneStar.Core.WWW.Class._classid_.Index>]
    [Cache]
    public sealed class ClassPropertyAbstractFragment : FragmentControlAttribute
    {
        /// <summary>
        ...
        /// Cannot be null.
        /// </param>
        public ClassPropertyAbstractFragment(IFragmentContext fragmentContext)
            : base(fragmentContext)
        {
            Key = "kleenestar.core:class.isabstract.label";
        }

...
{
    /// <summary>
    /// Represents a control fragment that provides a button link for adding a new tenant within the workspace.
    /// </summary>
    [Section<SectionHeadlinePrimary>]
    [Scope<global::KleeneStar.Core.WWW.Settings.Tenants.Index>]
    [Cache]
    public sealed class TenantAddButtonFragment : FragmentControlButtonLink
    {
        /// <summary>
        ...
        {
            Text = _ => "kleenestar.core:setting.tenant.add.label";

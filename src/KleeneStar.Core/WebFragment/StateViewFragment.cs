...
namespace KleeneStar.Core.WebFragment
{
    ...
    [Cache]
    public sealed class StateViewFragment : FragmentControlView
    {
        /// <summary>
        ...
        {
            RestUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.States.Wql>()
        };

        /// <summary>
        /// Returns the quick filter control for REST-based workflow state queries.
        /// </summary>
        public ControlRestQuickfilter Quickfilter { get; } = new ControlRestQuickfilter()
        {
            RestUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.States._classid_.Quickfilter>()
        };
        ...
        {
            RestUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.States._classid_.Table>()
        };
        ...
        /// </summary>
        public ControlPagination Pagination { get; } = new ControlPagination("id_3E796B872BE14FFCACF3537EBF6452C3")
        {
        };
        ...
        public StateViewFragment(IFragmentContext fragmentContext)

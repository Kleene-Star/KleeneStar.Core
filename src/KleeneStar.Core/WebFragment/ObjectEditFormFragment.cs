...
namespace KleeneStar.Core.WebFragment
{
    ...
    public sealed class ObjectEditFormFragment : FragmentControlRestFormEdit
    {
            ...
            : base(fragmentContext)
        {
            ...
            Uri = _ => CoreHub.GetUri<WWW.Api._1_.Objects.Index>();
        }
        ...
        /// </returns>
        private static IControlFormItem BuildElement(FormElement element, IDictionary<Guid, Field> fields)
        {
        ...
        /// </summary>
        private static IControlFormItem CreateInputForField(Field field)
        {

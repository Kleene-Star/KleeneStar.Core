...
namespace KleeneStar.Core.WebFragment
{
    ...
    public sealed class PriorityViewFragment : FragmentControlView
    {
        ...
        {
            RestUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Priorities.Wql>()
        };
        ...
        {
            RestUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Priorities._classid_.Quickfilter>()
        };
        ...
        {
            RestUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.Api._1_.Priorities._classid_.Table>()
        };

...
{
    /// <summary>
    /// Toolbar button over the text of a document or a post that opens the object's relations
    /// (<see cref="WWW.Issue._objectkey_.Relations"/>).
    /// </summary>
    /// <remarks>
    /// The counterpart of <see cref="ObjectToolbarAttachmentsFragment"/>, leading to the same
    /// page as <see cref="ObjectItemRelationsMoreFragment"/> in the overflow menu.
    /// </remarks>
    ...
    [Order(1)]
    [Cache]
    public sealed class ObjectToolbarRelationsFragment : FragmentControlToolbarItemButton
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        /// <param name="fragmentContext">The fragment context.</param>
        public ObjectToolbarRelationsFragment(IFragmentContext fragmentContext)
            : base(fragmentContext)
        {
            ...
            Tooltip = _ => "kleenestar.core:object.relations.card.header";

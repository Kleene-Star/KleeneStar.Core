...
namespace KleeneStar.Core.WebFragment.Object
{
    ...
    [Order(2)]
    [Cache]
    public sealed class ObjectTabDashboardTemplateFragment : FragmentControlDataTabTemplate, IScope
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        /// <param name="fragmentContext">The context of the fragment.</param>
        public ObjectTabDashboardTemplateFragment(IFragmentContext fragmentContext)

...
{
    /// <summary>
    /// Quickfilter header of the issue Gantt tab: the personal scopes the plan can honour
    ...
    /// <see cref="IssueTabGanttFragment"/>, which re-queries the plan.
    /// </remarks>
    [Section<SectionTabTemplatePrimary>]
    [Scope<IssueTabGanttTemplateFragment>]
    [Order(1)]
    [Cache]
    public sealed class IssueTabGanttQuickfilterFragment : FragmentControlPanel
    {
        /// <summary>
        /// Represents the unique identifier for the content used in the application.
        /// </summary>
        public static readonly string ContentId = "id_6D3B9052C8F45AE7B1D4FAC2E5093864";
        ...
        public IssueTabGanttQuickfilterFragment(IFragmentContext fragmentContext)
            : base(fragmentContext)
        {
            ...
            ((IViewStateModelBound)Quickfilter).Resource<IssueGanttResource>().Model("filter");

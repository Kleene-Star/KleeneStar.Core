...
namespace KleeneStar.Core.WebFragment.Object.Assets
{
    ...
    /// <see cref="AssetViewFragment"/> scoped to this template.
    /// </summary>
    [Section<SectionTabViewPrimary>]
    [Scope<AssetTabFragment>]
    [Order(0)]
    [Cache]
    public sealed class AssetViewTemplateFragment : FragmentControlDataTabTemplate, IScope
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        /// <param name="fragmentContext">The context of the fragment.</param>
        public AssetViewTemplateFragment(IFragmentContext fragmentContext)

...
namespace KleeneStar.Core.WebFragment
{
    ...
    [Scope<global::KleeneStar.Core.WWW.State._stateid_.Delete>]
    [Cache]
    public sealed class StateDeleteFormFragment : FragmentControlRestFormDelete
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        /// <param name="fragmentContext">The context of the fragment.</param>
        public StateDeleteFormFragment(IFragmentContext fragmentContext)

...
{
    /// <summary>
    /// Represents the dialog in which the permissions of a dashboard are administered.
    /// </summary>
    /// <remarks>
    /// The page carries no content of its own; the surface is contributed by
    /// <see cref="WebFragment.Dashboard.DashboardPermissionFragment"/>.
    /// </remarks>
    [WebIcon<IconUserShield>]
    [Title("kleenestar.core:dashboard.permission.title")]
    [Scope<IScopeGeneral>]
    [Cache]

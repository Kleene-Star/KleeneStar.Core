...
namespace KleeneStar.Core.WWW.SecurityLevels._classid_
{
    /// <summary>
    /// Provides functionality for overview security levels of a class.
    /// </summary>
    [WebIcon<IconShieldHalved>]
    [Title("kleenestar.core:securitylevel.manage.title")]
    [Description("kleenestar.core:securitylevel.manage.description")]
    [ClassIdSegment]
    [Scope<IScopeGeneral>]
    [Cache]
    public sealed class Index : IPage<VisualTreeWebApp>, IScopeGeneral
    {
        ...
        public void Process(IRenderContext renderContext, VisualTreeWebApp visualTree)
        {
            ...
            var uri = renderContext.PageContext.ApplicationContext.Route
                ...
                .Concat(new UriPathSegmentConstant("securitylevels")
                {

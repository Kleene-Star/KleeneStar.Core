...
namespace KleeneStar.Core.WWW.States._classid_
{
    /// <summary>
    /// Provides functionality for overview states.
    /// </summary>
    [WebIcon<IconCircleDot>]
    [Title("kleenestar.core:state.manage.title")]
    [Description("kleenestar.core:state.manage.description")]
    [ClassIdSegment]
    [Scope<IScopeGeneral>]
    [Cache]
    public sealed class Index : IPage<VisualTreeWebApp>, IScopeGeneral
    {
        ...
        public void Process(IRenderContext renderContext, VisualTreeWebApp visualTree)
        {
            ...
            var uri = renderContext.PageContext.ApplicationContext.Route
                ...
                .Concat(new UriPathSegmentConstant("states")
                {

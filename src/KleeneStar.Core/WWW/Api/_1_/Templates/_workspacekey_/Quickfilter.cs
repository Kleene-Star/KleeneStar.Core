...
{
    /// <summary>
    /// Provides a quick filter implementation for template entities in the REST API.
    /// This class enables filtering of template items using predefined criteria.
    /// </summary>
    public sealed class Quickfilter : RestApiQuickfilter<Model.Entities.Template>
    {
        /// <summary>

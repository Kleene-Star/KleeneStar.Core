...
namespace KleeneStar.Core.WWW.Api._1_.Objects._workspacekey_
{
    ...
    public sealed class Table : RestApiTable<Model.Entities.Object>
    {
        ...
        /// </returns>
        public override IUri GetUri(Model.Entities.Object row, IRequest request)
        {
        ...
        /// </returns>
        public override IUri GetRestApiForInlineEdit(Model.Entities.Object row, IRequest request)
        {

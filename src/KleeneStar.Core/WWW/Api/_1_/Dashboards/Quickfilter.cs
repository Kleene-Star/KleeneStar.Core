...
{
    /// <summary>
    /// Provides a quick filter implementation for dashboard entities in the REST API. 
    /// This class enables filtering of dashboard items using predefined criteria.
    /// </summary>
    public sealed class Quickfilter : RestApiQuickfilter<Model.Entities.Dashboard>
    {
        /// <summary>

...
{
    /// <summary>
    /// Represents a unique tenant name within the system, providing functionality to validate 
    /// and check the availability of tenant names.
    /// </summary>
    [Title("Tenants")]
    [Cache]
    public sealed partial class UniqueName : RestApiUnique
    {
        ...
        protected override bool CheckAvailable(string value, Request request)
        {
            ...
            var query = new Query<Model.Entities.Tenant>()

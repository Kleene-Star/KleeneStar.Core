...
{
    /// <summary>
    /// Represents a unique form name within the system, providing functionality to validate 
    /// and check the availability of form names.
    /// </summary>
    [Title("Forms")]
    [Cache]
    public sealed partial class UniqueName : RestApiUnique
    {
        ...
        protected override bool CheckAvailable(string value, Request request)
        {
            ...
            var query = new Query<Model.Entities.Form>()

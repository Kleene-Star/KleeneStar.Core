...
namespace KleeneStar.Core.WWW.Api._1_.States
{
    ...
    /// </summary>
    [Cache]
    public sealed class Index : RestApiCrud<Model.Entities.WorkflowState>
    {
        /// <summary>
        ...
        /// </returns>
        protected override IEnumerable<Model.Entities.WorkflowState> Retrieve(IQuery<Model.Entities.WorkflowState> query, IQueryContext context, IRequest request)
        {
            return CoreHub.WorkflowStateManager.GetStates(query, context);
        }
        ...
        {
            return RetrieveForCreate(request, "kleenestar.core:state.add.title");
        }
        ...
        /// </returns>
        protected override IRestApiCrudResultRetrieve RetrieveForClone(IQuery<Model.Entities.WorkflowState> query, IRequest request)
        {
            using var context = ModelHub.CreateDbContext();
            var data = CoreHub.WorkflowStateManager.GetStates(query, context)
                .FirstOrDefault();

            var newItem = new Model.Entities.WorkflowState()
            {
                Name = data.Name + " (Copy)",
            ...
            return RetrieveForClone(request, newItem, "kleenestar.core:state.clone.title");
        }
        ...
        /// </returns>
        protected override IRestApiCrudResultRetrieve RetrieveForUpdate(IQuery<Model.Entities.WorkflowState> query, IRequest request)
        {
            using var context = ModelHub.CreateDbContext();
            var data = CoreHub.WorkflowStateManager.GetStates(query, context)
                .FirstOrDefault();

            return RetrieveForUpdate(request, data, "kleenestar.core:state.edit.title");
        }
        ...
        /// </returns>
        protected override IRestApiCrudResultRetrieveDelete RetrieveForDelete(IQuery<Model.Entities.WorkflowState> query, IRequest request)
        {
            using var context = ModelHub.CreateDbContext();
            var data = CoreHub.WorkflowStateManager.GetStates(query, context)
                .FirstOrDefault();

            return RetrieveForDelete(request, data, "kleenestar.core:state.delete.title", data?.Id.ToString());
        }
        ...
        /// </returns>
        protected override IRestApiValidationResult Validate(Model.Entities.WorkflowState existingItem, RestApiCrudFormData payload, IRequest request)
        {
        ...
        /// </returns>
        protected override IRestApiCrudResultCreate Create(RestApiCrudFormData fieldMap, IRequest request, out Model.Entities.WorkflowState newItem)
        {
            var id = Guid.NewGuid();
            newItem = new Model.Entities.WorkflowState(id)
            {
            ...
            CoreHub.WorkflowStateManager.Add(newItem);
        ...
        /// </returns>
        protected override IRestApiCrudResultCreate Clone(Model.Entities.WorkflowState existingItem, RestApiCrudFormData fieldMap, IRequest request, out Model.Entities.WorkflowState newItem)
        {
            var id = Guid.NewGuid();
            newItem = new Model.Entities.WorkflowState(id)
            {
        ...
        /// The HTTP request providing additional context.
        /// </param>
        protected override IRestApiCrudResultUpdate Update(Model.Entities.WorkflowState existingItem, RestApiCrudFormData payload, IRequest request)
        {
            var res = base.Update(existingItem, payload, request);

            CoreHub.WorkflowStateManager.Update(existingItem);
        ...
        /// </returns>
        protected override IRestApiCrudResultDelete Delete(Model.Entities.WorkflowState existingItem, IRequest request)
        {
            CoreHub.WorkflowStateManager.Remove(existingItem.Id);

...
namespace KleeneStar.Core.WWW.Api._1_.States._classid_
{
    /// <summary>
    ...
    /// </summary>
    [Title("kleenestar.core:state.table.header")]
    [Cache]
    public sealed class Table : RestApiTable<Model.Entities.WorkflowState>
    {
        ...
        public Table()
        {
            _editFormUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.State._stateid_.Edit>();
            _cloneFormUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.State._stateid_.Clone>();
            _deleteFormUri = CoreHub.GetUri<global::KleeneStar.Core.WWW.State._stateid_.Delete>();
        }
        ...
        /// </returns>
        protected override IEnumerable<RestApiTableRow> RetrieveRows(IQuery<Model.Entities.WorkflowState> query, IQueryContext context, IEnumerable<RestApiTableColumn> columns, IRequest request)
        {
        ...
        /// </returns>
        protected override IQuery<Model.Entities.WorkflowState> Filter(string filter, IQuery<Model.Entities.WorkflowState> query, IRequest request)
        {
        ...
        /// </param>
        private IEnumerable<RestApiOption> GetOptions(Model.Entities.WorkflowState row, IRequest request)
        {
        ...
        /// </returns>
        private static IUri GetUri(Model.Entities.WorkflowState row, IRequest request)
        {
            return null;
        }

...
{
    /// <summary>
    /// Represents a unique workflow name within the system, providing functionality to validate 
    /// and check the availability of workflow names.
    /// </summary>
    [Title("States")]
    [Cache]
    public sealed partial class UniqueName : RestApiUnique
    {
        ...
        protected override bool CheckAvailable(string value, Request request)
        {
            ...
            var query = new Query<Model.Entities.WorkflowState>()

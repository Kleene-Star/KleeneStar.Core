...
namespace KleeneStar.Core.WWW.Api._1_.Workflows
{
    ...
    public sealed class State : RestApiSelection<Model.Entities.Workflow>
    {
        /// <summary>
        ...
        /// </returns>
        protected override IQueryable<RestApiSelectionItem> RetrieveItems(IQuery<Model.Entities.Workflow> query, IQueryContext context, IRequest request)
        {

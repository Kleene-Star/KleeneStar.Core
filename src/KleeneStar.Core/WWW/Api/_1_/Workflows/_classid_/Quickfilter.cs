...
{
    /// <summary>
    /// Provides a quick filter implementation for workflow entities in the REST API. 
    /// This class enables filtering of filed items using predefined criteria.
    /// </summary>
    public sealed class Quickfilter : RestApiQuickfilter<Model.Entities.Workflow>
    {
        /// <summary>

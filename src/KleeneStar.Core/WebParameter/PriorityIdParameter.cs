...
{
    /// <summary>
    /// Represents a parameter that specifies a priority id.
    /// </summary>
    public sealed class PriorityIdParameter : IParameterStatic
    {
        /// <summary>
        ...
        public PriorityIdParameter(string value)
        {
            Value = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the parameter.</param>
        public PriorityIdParameter(Guid value)
        {

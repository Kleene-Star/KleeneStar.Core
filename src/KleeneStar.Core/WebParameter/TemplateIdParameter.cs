...
{
    /// <summary>
    /// Represents a parameter that specifies a template id.
    /// </summary>
    public sealed class TemplateIdParameter : IParameterStatic
    {
        /// <summary>
        /// Gets the key that uniquely identifies the parameter in configuration or
        /// settings contexts.
        /// </summary>
        public static string Key => "templateid";
        ...
        public TemplateIdParameter(string value)
        {
            Value = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the parameter.</param>
        public TemplateIdParameter(Guid value)
        {

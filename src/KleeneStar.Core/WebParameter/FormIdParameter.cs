...
{
    /// <summary>
    /// Represents a parameter that specifies a form id.
    /// </summary>
    public sealed class FormIdParameter : IParameterStatic
    {
        /// <summary>
        /// Returns the key that uniquely identifies the parameter in configuration or
        /// settings contexts.
        /// </summary>
        public static string Key => "formid";
        ...
        public FormIdParameter(string value)
        {
            Value = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the parameter.</param>
        public FormIdParameter(Guid value)
        {

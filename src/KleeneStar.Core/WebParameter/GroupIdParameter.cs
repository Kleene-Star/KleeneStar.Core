...
{
    /// <summary>
    /// Represents a parameter that specifies a group id.
    /// </summary>
    public sealed class GroupIdParameter : IParameterStatic
    {
        /// <summary>
        /// Gets the key that uniquely identifies the parameter.
        /// </summary>
        ...
        public GroupIdParameter(string value)
        {
            Value = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the parameter.</param>
        public GroupIdParameter(Guid value)
        {

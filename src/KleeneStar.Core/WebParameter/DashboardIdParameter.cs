...
{
    /// <summary>
    /// Represents a parameter that specifies a dashboard id.
    /// </summary>
    public sealed class DashboardIdParameter : IParameterStatic
    {
        /// <summary>
        /// Gets the key that uniquely identifies the parameter in configuration or
        /// settings contexts.
        /// </summary>
        public static string Key => "dashboardid";
        ...
        public DashboardIdParameter(string value)
        {
            Value = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the parameter.</param>
        public DashboardIdParameter(Guid value)
        {

...
{
    /// <summary>
    /// Represents a parameter that specifies an identity id.
    /// </summary>
    public sealed class IdentityIdParameter : IParameterStatic
    {
        /// <summary>
        /// Gets the key that uniquely identifies the parameter in configuration or
        /// settings contexts.
        /// </summary>
        public static string Key => "identityid";
        ...
        public IdentityIdParameter(string value)
        {
            Value = value;
        }
        ...
        /// </summary>
        /// <param name="value">The value of the parameter.</param>
        public IdentityIdParameter(Guid value)
        {
